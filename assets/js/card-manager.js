...
class NexusCardManager {
    ...
    getSocialPlatforms() {
        return [
            { platform: 'GitHub', icon: 'github', baseUrl: '' },
            { platform: 'LinkedIn', icon: 'linkedin', baseUrl: '' },
            { platform: 'Twitter', icon: 'twitter', baseUrl: '' },
            { platform: 'Discord', icon: 'discord', baseUrl: '' },
            { platform: 'YouTube', icon: 'youtube', baseUrl: '' },
            { platform: 'Spotify', icon: 'spotify', baseUrl: '' },
            { platform: 'Steam', icon: 'steam', baseUrl: '' },
            { platform: 'Email', icon: 'email', baseUrl: '' }
        ];
    }
}
