...
class PortfolioApp {
            ...
            this.projects = [
                {
                    ...
                    description: "A sophisticated collection of custom-built iOS widgets leveraging the Scriptable API. Each widget is designed to enhance productivity by delivering real-time data and automated workflows directly to the iOS home screen.",
                    technologies: ["JavaScript", "iOS API", "Automation"],
                    category: "automation",
                    image: "assets/projects/ios-banner.png",
                    githubUrl: "https://gokul-codes-420.github.io/Master---Coder/",
                    liveUrl: "",
                    featured: true
                },
                {
                    id: 2,
                    title: "Gokul Bashfolio",
                    description: "An innovative terminal-style portfolio interface that mirrors a real Bash environment.",
                    technologies: ["JavaScript", "CSS3", "Terminal Emulation"],
                    category: "web",
                    image: "assets/projects/terminal-banner.png",
                    githubUrl: "https://github.com/gokul-codes-420/Gokul-Bashfolio",
                    liveUrl: "",
                    featured: true
                },
                {
                    id: 3,
                    title: "GitHub Advanced Widget",
                    description: "A comprehensive monitoring tool for developers that visualizes GitHub contributions.",
                    technologies: ["JavaScript", "GitHub API", "Data Visualization"],
                    category: "automation",
                    image: "assets/projects/github-banner.png",
                    githubUrl: "https://github.com/gokul-codes-420/GitHub-Widget",
                    liveUrl: "",
                    featured: true
                }
            ];
    ...
    createProjectCard(project, index = 0) {
        ...
        card.className = `project-card minimalist-showcase ${isEven ? 'row' : 'row-reverse'} scroll-reveal enhanced-hover`;
        ...
        card.innerHTML = `
            <div class="project-image-wrapper">
                <img src="${projectImage}" alt="${project.title}" class="project-image" loading="lazy" 
                     onerror="this.src='https://placehold.co/600x400/1a1a2e/6366f1/png?text=${encodeURIComponent(project.title)}'">
            </div>
            <div class="project-content">
                <div class="project-meta">
                    <span class="project-category">${project.category}</span>
                    ${project.featured ? '<span class="featured-dot"></span>' : ''}
                </div>
    ...
    handleContactForm(e) {
        ...
        fetch('/', {
            ...
            .catch((error) => {
                ...
                this.showNotification('❌ Failed to send message. Please try emailing me directly at gokulsanth33010@gmail.com', 'error');
            })
            .finally(() => {
